    ...
    <div class="container">
        <ul>
            ...
            <?php foreach($breadcrumbs as $breadcrumb): ?>
                <li><a href="/category/<?=$breadcrumb['id']?>"> <?=$breadcrumb['title']?></a> <span>|</span>  </li>
            <?php endforeach; ?>
        </ul>
    </div>
</div>
                                        ...
                                        <figure>
                                            <div class="snipcart-item block">
                                                ...
                                                <div class="snipcart-details">
                                                    <a href="<?=\yii\helpers\Url::to(['cart/add', 'id'=>$product->id]) ?>" data-id="<?=$product->id?>" class="button add-to-cart">В корзину</a>
                                                </div>
                                            </div>
                                        </figure>
                                    </div>
