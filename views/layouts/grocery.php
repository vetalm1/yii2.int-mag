...
<div class="agileits_header">
    ...
    <div class="product_list_header">
        <button type="button" onclick="getCart()" class="button" data-toggle="modal" data-target="#modal-cart">  <?php  //кнопка корзины  ?>
           <span class="cart-sum"> Корзина ($<?=isset($_SESSION['cart.sum']) ?
                                                      $_SESSION['cart.sum'] : '0' ?>) </span>
        </button>
...
<!-- //header -->
    ...
    <?= $content // берется текс из homeController/index.php ?>
...
<!-- //here ends scrolling icon  ALL js in main.js-->
