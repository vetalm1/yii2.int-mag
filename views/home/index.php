                                        ...
                                        <figure>
                                            <div class="snipcart-item block" >
                                                <div class="snipcart-thumb">
                                                    ...
                                                    <h4>
                                                        $<?= $offer->price ?>
                                                        <?php if((float)$offer->old_price): // т.к. из базы возвращается строка(string)?>
                                                            <span>$<?= $offer->old_price ?></span>
                                                        <?php endif; ?>
                                                    </h4>
                                                </div>
                                                <div class="snipcart-details top_brand_home_details">
                                                    <a href="<?=\yii\helpers\Url::to(['cart/add', 'id'=>$offer->id]) ?>" data-id="<?=$offer->id?>" class="button add-to-cart">В корзину</a>
